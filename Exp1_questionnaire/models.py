...
class Treatment(object):
    ...
    def get_treatment(player):
        ...
        if Constants.key_method not in participant.vars:
            ...
            randomchoice = random.choice(['control', 'treatmentWill'])            
            participant.vars[Constants.key_method] = randomchoice#_隨機選擇完放dict
...
class OptionOfGetMoney(object):
    ...
    def formatted_option(player, part1, part2, part3):
        if player.treatment_method == "control":
            ...
            return part1, part2 + Treatment.futureTense + part3 #_呼叫"將", 組合後一起回傳
...
class Player(BasePlayer):
    ...
    def switch_point_choices(self):
        ...
        options = options_part1 + str(self.waiting_period) + options_part2 #_組合句子
